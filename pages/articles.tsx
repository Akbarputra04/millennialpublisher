                        ...
                        {data.map(d => (
                            <div key={d} className="overflow-hidden bg-white rounded shadow">
                                <div className="p-5">
                                    ...
                                    <Link href="/article-detail" title="" className="inline-flex items-center justify-center pb-0.5 mt-5 text-base font-semibold text-blue-600 transition-all duration-200 border-b-2 border-transparent hover:border-blue-600 focus:border-blue-600">
                                        Continue Reading

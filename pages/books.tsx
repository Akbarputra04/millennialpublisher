                ...
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="flex items-end justify-between">
                        <div className="flex-1 text-center lg:text-left">
                            <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">Books from millennial publisher</h2>
                    ...
                    <div className="grid max-w-md grid-cols-2 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-4 lg:max-w-full">
                        {data.map(d => (
                            <div key={d} className="overflow-hidden bg-white rounded-md shadow-md">
                                <div className="p-5">

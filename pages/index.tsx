					...
					<div className="px-4 mx-auto max-w-6xl sm:px-6 lg:px-8">
						<div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
							<div>
								...
								<p className="mt-8 text-base sm:text-xl">Millennium Publisher sejak 1999 turut berkotribusi dalam industri penerbitan buku, menghadirkan sajian literasi, turut membangun wawasan dan memperkaya khasanah perspektif kognitif untuk negeri</p>
					...
					<div className="grid grid-cols-1 gap-12 lg:grid-cols-3">
						<div className="lg:row-start-1 lg:row-end-3">
							...
							<p className="mt-5 text-2xl font-semibold">
								<h4 title="" className="text-black">Lorem, ipsum.</h4>
							</p>
